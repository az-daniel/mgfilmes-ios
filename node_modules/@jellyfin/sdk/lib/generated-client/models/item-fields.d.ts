 ...
 * @enum {string}
 */
export declare const ItemFields: {
    ...
    readonly DateLastMediaAdded: "DateLastMediaAdded";
    readonly DisplayPreferencesId: "DisplayPreferencesId";
    readonly Etag: "Etag";
    ...
    readonly PlayAccess: "PlayAccess";
    ...
    readonly ChannelImage: "ChannelImage";
    readonly EnableMediaSourceDisplay: "EnableMediaSourceDisplay";
    readonly Width: "Width";
    readonly Height: "Height";
    readonly ExtraIds: "ExtraIds";
    readonly LocalTrailerCount: "LocalTrailerCount";
    readonly IsHd: "IsHD";
    readonly SpecialFeatureCount: "SpecialFeatureCount";
};
