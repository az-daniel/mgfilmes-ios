 ...
 * @export
 */
export declare const TmdbApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
 ...
 * @export
 */
export declare const TmdbApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Gets the TMDb image configuration options.
     * @param {*} [options] Override http request option.
 ...
 * @export
 */
export declare const TmdbApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     *
     * @summary Gets the TMDb image configuration options.
     * @param {*} [options] Override http request option.
 ...
 * @extends {BaseAPI}
 */
export declare class TmdbApi extends BaseAPI {
    /**
     *
     * @summary Gets the TMDb image configuration options.
     * @param {*} [options] Override http request option.
