 ...
 * @export
 */
export declare const ItemRefreshApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
 ...
 * @export
 */
export declare const ItemRefreshApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Refreshes metadata for an item.
     * @param {string} itemId Item id.
 ...
 * @export
 */
export declare const ItemRefreshApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     *
     * @summary Refreshes metadata for an item.
 ...
 * @extends {BaseAPI}
 */
export declare class ItemRefreshApi extends BaseAPI {
    /**
     *
     * @summary Refreshes metadata for an item.
     * @param {ItemRefreshApiRefreshItemRequest} requestParameters Request parameters.
