...
export declare const DashboardApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getConfigurationPages: (enableInMainMenu?: boolean, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getDashboardConfigurationPage: (name?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const DashboardApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getConfigurationPages(enableInMainMenu?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ConfigurationPageInfo>>>;
    /**
     *
     * @summary Gets a dashboard configuration page.
     * @param {string} [name] The name of the page.
     ...
     * @throws {RequiredError}
     */
    getDashboardConfigurationPage(name?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>>;
};
/**
