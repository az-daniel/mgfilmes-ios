 ...
 * @export
 */
export declare const DisplayPreferencesApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
     ...
     */
    getDisplayPreferences: (displayPreferencesId: string, client: string, userId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    updateDisplayPreferences: (displayPreferencesId: string, client: string, displayPreferencesDto: DisplayPreferencesDto, userId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * DisplayPreferencesApi - functional programming interface
 * @export
 */
export declare const DisplayPreferencesApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Get Display Preferences.
     * @param {string} displayPreferencesId Display preferences id.
     ...
     * @throws {RequiredError}
     */
    getDisplayPreferences(displayPreferencesId: string, client: string, userId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DisplayPreferencesDto>>;
    /**
     *
     * @summary Update Display Preferences.
     * @param {string} displayPreferencesId Display preferences id.
     ...
     * @throws {RequiredError}
     */
    updateDisplayPreferences(displayPreferencesId: string, client: string, displayPreferencesDto: DisplayPreferencesDto, userId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
 * DisplayPreferencesApi - factory interface
 * @export
 */
export declare const DisplayPreferencesApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     *
     * @summary Get Display Preferences.
 ...
 * @extends {BaseAPI}
 */
export declare class DisplayPreferencesApi extends BaseAPI {
    /**
     *
     * @summary Get Display Preferences.
     * @param {DisplayPreferencesApiGetDisplayPreferencesRequest} requestParameters Request parameters.
