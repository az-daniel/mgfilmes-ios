 ...
 * @export
 */
export declare const TimeSyncApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
 ...
 * @export
 */
export declare const TimeSyncApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Gets the current UTC time.
     * @param {*} [options] Override http request option.
 ...
 * @export
 */
export declare const TimeSyncApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     *
     * @summary Gets the current UTC time.
     * @param {*} [options] Override http request option.
 ...
 * @extends {BaseAPI}
 */
export declare class TimeSyncApi extends BaseAPI {
    /**
     *
     * @summary Gets the current UTC time.
     * @param {*} [options] Override http request option.
