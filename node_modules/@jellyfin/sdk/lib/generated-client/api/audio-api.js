 ...
 * @export
 */
const AudioApiAxiosParamCreator = function (configuration) {
    return {
        /**
         *
 ...
 * @export
 */
const AudioApiFp = function (configuration) {
 ...
 * @export
 */
const AudioApiFactory = function (configuration, basePath, axios) {
 ...
 * @extends {BaseAPI}
 */
class AudioApi extends BaseAPI {
    /**
     *
     * @summary Gets an audio stream.
     * @param {AudioApiGetAudioStreamRequest} requestParameters Request parameters.
...
export { AudioApi, AudioApiAxiosParamCreator, AudioApiFactory, AudioApiFp };
