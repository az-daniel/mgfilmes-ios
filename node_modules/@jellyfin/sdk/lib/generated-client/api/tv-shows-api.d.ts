 ...
 * @export
 */
export declare const TvShowsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
 ...
 * @export
 */
export declare const TvShowsApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Gets episodes for a tv season.
     * @param {string} seriesId The series id.
 ...
 * @export
 */
export declare const TvShowsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     *
     * @summary Gets episodes for a tv season.
 ...
 * @extends {BaseAPI}
 */
export declare class TvShowsApi extends BaseAPI {
    /**
     *
     * @summary Gets episodes for a tv season.
     * @param {TvShowsApiGetEpisodesRequest} requestParameters Request parameters.
