 ...
 * @export
 */
export declare const ImageByNameApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
     ...
     */
    getGeneralImage: (name: string, type: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getGeneralImages: (options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getMediaInfoImage: (theme: string, name: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getMediaInfoImages: (options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getRatingImage: (theme: string, name: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     * @summary Get all general images.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getRatingImages: (options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * ImageByNameApi - functional programming interface
 * @export
 */
export declare const ImageByNameApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Get General Image.
     * @param {string} name The name of the image.
     ...
     * @throws {RequiredError}
     */
    getGeneralImage(name: string, type: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>>;
    /**
     *
     * @summary Get all general images.
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    getMediaInfoImage(theme: string, name: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>>;
    /**
     *
     * @summary Get all media info images.
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    getRatingImage(theme: string, name: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>>;
    /**
     *
     * @summary Get all general images.
     * @param {*} [options] Override http request option.
