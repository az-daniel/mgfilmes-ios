 ...
 * @export
 */
export declare const GenresApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
 ...
 * @export
 */
export declare const GenresApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Gets a genre, by name.
     * @param {string} genreName The genre name.
 ...
 * @export
 */
export declare const GenresApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     *
     * @summary Gets a genre, by name.
 ...
 * @extends {BaseAPI}
 */
export declare class GenresApi extends BaseAPI {
    /**
     *
     * @summary Gets a genre, by name.
     * @param {GenresApiGetGenreRequest} requestParameters Request parameters.
