 ...
 * @export
 */
export declare const PackageApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
     ...
     * @throws {RequiredError}
     */
    setRepositories: (repositoryInfo: Array<RepositoryInfo>, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * PackageApi - functional programming interface
 * @export
 */
export declare const PackageApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Cancels a package installation.
     * @param {string} packageId Installation Id.
     ...
     * @throws {RequiredError}
     */
    getPackages(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PackageInfo>>>;
    /**
     *
     * @summary Gets all package repositories.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getRepositories(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RepositoryInfo>>>;
    /**
     *
     * @summary Installs a package.
     * @param {string} name Package name.
     ...
     * @throws {RequiredError}
     */
    setRepositories(repositoryInfo: Array<RepositoryInfo>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
 * PackageApi - factory interface
 * @export
 */
export declare const PackageApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     *
     * @summary Cancels a package installation.
 ...
 * @extends {BaseAPI}
 */
export declare class PackageApi extends BaseAPI {
    /**
     *
     * @summary Cancels a package installation.
     * @param {PackageApiCancelPackageInstallationRequest} requestParameters Request parameters.
