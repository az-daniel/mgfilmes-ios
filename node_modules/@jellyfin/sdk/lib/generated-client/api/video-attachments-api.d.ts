 ...
 * @export
 */
export declare const VideoAttachmentsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     *
 ...
 * @export
 */
export declare const VideoAttachmentsApiFp: (configuration?: Configuration) => {
    /**
     *
     * @summary Get video attachment.
     * @param {string} videoId Video ID.
 ...
 * @export
 */
export declare const VideoAttachmentsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     *
     * @summary Get video attachment.
 ...
 * @extends {BaseAPI}
 */
export declare class VideoAttachmentsApi extends BaseAPI {
    /**
     *
     * @summary Get video attachment.
     * @param {VideoAttachmentsApiGetAttachmentRequest} requestParameters Request parameters.
